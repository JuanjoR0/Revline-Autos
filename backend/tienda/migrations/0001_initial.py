    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('coche', 'Coche'), ('moto', 'Moto'), ('especial', 'Especial')], max_length=20)),
                ('precio', models.DecimalField(decimal_places=2, max_digits=10)),
                ('stock', models.PositiveIntegerField(default=0)),
                ('velocidad', models.DecimalField(decimal_places=2, max_digits=5)),
                ('frenado', models.DecimalField(decimal_places=2, max_digits=5)),
                ('aceleracion', models.DecimalField(decimal_places=2, max_digits=5)),
                ('traccion', models.DecimalField(decimal_places=2, max_digits=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('cliente', 'Cliente'), ('administrador', 'Administrador'), ('empleado', 'Empleado')], default='cliente', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehiculo', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tienda.vehiculo')),
            ],
        ),
    ]
