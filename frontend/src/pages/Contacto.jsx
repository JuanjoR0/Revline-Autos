      ...
      <div className="contacto-contenido container">
        ...
        <div className="contacto-correo">
          <div className="correo-texto">
            ...
            <p>
              ¿Tienes alguna consulta o necesitas asistencia personalizada?  
        ...
        <div className="contacto-mapa-seccion">
          ...
          <div className="info-contacto">
            ...
            <div className="info-item">
              ...
              <p>
                <strong>Dirección:</strong> Calle Falsa 123, Almuñécar (Granada)
              </p>
            </div>
            ...
            <div className="info-item">
              ...
              <p>
                <strong>WhatsApp:</strong> +34 661 30 73 27
              </p>
            </div>

            <p className="info-texto-final">
              Puedes visitarnos en nuestro taller o escribirnos directamente a través de WhatsApp.
            </p>
          </div>
          {/* 📍 MAPA */}
          <div className="mapa-container">
            <iframe
              title="Mapa Almuñécar"
